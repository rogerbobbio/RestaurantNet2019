...
{
  public partial class frmCustomerOrderCancel : frmMain
  {
    public int pedidoID = 0;
    public int mesaID = 0;

    public frmCustomerOrderCancel()
    {
      InitializeComponent();
    }
    ...
    private bool IsReadyToSave()
    {
      ...
      if (txtComentarios.Text == string.Empty)
      {
        ...
        epComentarios.SetError(txtComentarios, "Por favor ingresar las razones de la anulacion.");
        valueResult = false;
      }      
      return valueResult;
    }
